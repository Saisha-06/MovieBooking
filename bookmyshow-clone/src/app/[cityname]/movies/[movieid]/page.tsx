                    ...
                    <div className='c2'>
                        ...
                        <p>{movie.description}</p>
                        {
                            ...
                            <div className='circlecardslider'>
                                ...
                                >
                                    {
                                        movie.cast.map((cast: React.JSX.IntrinsicAttributes & CelebrityCardType, index: React.Key | null | undefined) => {
                                            return (
                        ...
                        }
                        {
                            ...
                            <div className='circlecardslider'>
                                ...
                                >
                                    {
                                        movie.crew.map((cast: React.JSX.IntrinsicAttributes & CelebrityCardType, index: React.Key | null | undefined) => {
                                            return (
                                                <SwiperSlide key={index}>
                                                    <CelebCard {...cast} />
                                                </SwiperSlide>
